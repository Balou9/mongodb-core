...
export function  insert(server: unknown, ns: string, ops: unknown, options: {[key:string]: any}, callback: Callback) {
    writeCommand(server, 'insert', 'documents', ns, ops, options, callback);
  }
  
export function  update(server: unknown, ns: string, ops: unknown,options : {[key:string]: any}, callback: Callback) {
    writeCommand(server, 'update', 'updates', ns, ops, options, callback);
  }
  
export  function remove(server: unknown, ns: string, ops: unknown, options: {[key:string]: any}, callback: Callback) {
